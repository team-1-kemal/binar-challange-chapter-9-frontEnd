    ...
    <div>
      ...
      <section className="game-page">
        ...
        <div className="game_score flex mt-[50px] gap-[70px] md:gap-[350px] lg:gap-[400px] md:mt-[0px]">
          <div>
            <h1 className="text-center text-white text-md md:text-xl text-user-point">
              User Points
            </h1>
            <h5 className="text-center text-white text-xl md:text-3xl user-point">
              {userScore}
            </h5>
          </div>
          <div>
        ...
        <div className="choices mt-[20px]">
          ...
          <div className="game-result mt-[-90px] md:mt-[-230px]">
            ...
            {gameOver && (
              <div>
                <h1 className="text-center text-sm md:text-2xl text-result mt-[-20px]">
                  You
                </h1>
                <h1 className="text-result text-lg md:text-4xl text-center">
                  {result}
                </h1>
              </div>
            )}
